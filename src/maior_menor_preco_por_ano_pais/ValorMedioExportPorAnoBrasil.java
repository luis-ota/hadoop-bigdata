...
public class ValorMedioExportPorAnoBrasil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // arquivo de saida
        Path output = new Path("src/valor_medio_por_ano_export_brasil/valor_medio_por_ano_export_brasil_resultados");
    ...
    public static class BrazilTransactionMapper extends Mapper<LongWritable, Text, Text, DoubleWritable> {
        public void map(LongWritable key, Text value, Context context)
            ...
            if (parts.length < 10 || !parts[0].equals("Brazil") || !parts[4].equals("Export") || parts[5].isEmpty() || parts[1].isEmpty()){return;}
