...
public class ContagemBrasil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // arquivo de saida
        Path output = new Path("src/contagem_brasil/contagem_brasil_resultados");
        ...
        Job j = new Job(c, "ContagemBrasil");

        // registro das classes
        j.setJarByClass(ContagemBrasil.class);
    ...
    public static class BrazilTransactionMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
        public void map(LongWritable key, Text value, Context context)
            ...
            if (parts.length >= 10 && parts[0].equals("Brazil")) {
